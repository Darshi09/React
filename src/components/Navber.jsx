...
const Navber = () => {
  ...
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    >
      <img
        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-LxmuSoKB3pA0fEIhigo6Z9PLPQvGmWmcYQ&s"
        className="h-8"
        alt="Flowbite Logo"
      />
      ...
      >
        ...
        <img
          className="w-8 h-8 rounded-full"
            src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGbHk--_QshBpghcgS4SBcjJIpkDzZ2GMtAw&s'
          alt="user photo"
        />
      </button>
      {/* Dropdown menu */}
